...
namespace DDona.DDD.PaymentContext.Domain.ValueObjects
{
    public class Document : ValueObject
    {
        ...
        private bool ValidateNumber()
        {
            ...
            {
                return ValidateNumberCNPJ();
            }

            if (Type == EDocumentType.CPF && Number.Length == 11)
            {
                return ValidateNumberCPF();
            }

            return false;
        }

        private bool ValidateNumberCPF()
        {
            string cpf = this.Number;
        ...
        private bool ValidateNumberCNPJ()
        {
            string cnpj = this.Number;
